...
public class Start_Stop_AppiumServer  {
	...
	//Process p = Runtime.getRuntime().exec("/usr/local/bin/node /usr/local/bin/appium\" /node .\" /--platform-name "ios" \" /--platform-version 9.0\" /--device-name "iPhone 6"\" / --app "/Users/monocept/Desktop/weather_app_files/Payload/TheWeather.app" -l\"};
	 CommandLine command = new CommandLine("/Applications/Appium.app/Contents/Resources/node/bin/node");  
        command.addArgument("/Applications/Appium.app/Contents/Resources/node_modules/appium/bin/appium.js", false); 
